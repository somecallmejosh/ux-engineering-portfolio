...
const _assets = {
  ["nuxt-og-image:fonts:Inter-normal-400.ttf.base64"]: {
    ...
    meta: {"type":"text/plain; charset=utf-8","etag":"\"652cc-qEeSD1DXCSV8gPP2rnBA6ePGdZ4\"","mtime":"2026-03-10T02:16:45.672Z"}
  },
  ["nuxt-og-image:fonts:Inter-normal-700.ttf.base64"]: {
    import: () => import('../raw/Inter-normal-700.ttf.mjs').then(r => r.default || r),
    meta: {"type":"text/plain; charset=utf-8","etag":"\"674f0-FZReUXHhPTnY0HmYVn2iPpKm9ds\"","mtime":"2026-03-10T02:16:45.672Z"}
  }
};
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "83a92afc-c323-41cc-82ae-065f2811f0e1",
    ...
    "routeRules": {
      ...
      "/blog/categories/**": {
        "redirect": {
          "to": "/blog/tags/**/",
          "statusCode": 301,
          "_redirectStripBase": "/blog/categories"
        }
      },
      "/dev-notes/categories/**": {
        "redirect": {
          "to": "/dev-notes/tags/**/",
          "statusCode": 301,
          "_redirectStripBase": "/dev-notes/categories"
        }
      },
      "/checklist/": {
        "sitemap": false
      ...
      "/__nuxt_content/projects/sql_dump": {
        "prerender": true
      },
      "/__nuxt_content/experiments/sql_dump": {
        "prerender": true
      },
      "/__nuxt_content/services/sql_dump": {
        "prerender": true
      },
      "/__nuxt_content/checklist/sql_dump": {
        "prerender": true
      },
      "/__nuxt_content/dev_notes/sql_dump": {
        "prerender": true
      },
      "/_nuxt": {
        "robots": "noindex",
  ...
  "public": {
    "sqlPath": "/Users/joshuabriley/node_modules/.pnpm/@sqlite.org+sqlite-wasm@3.49.0-build3/node_modules/@sqlite.org/sqlite-wasm/sqlite-wasm/jswasm/sqlite3.wasm",
  ...
  "resendKey": "re_JymtTxpZ_MVoNMj42x3kmACRUpAjv6QGP",
  "resendFrom": "josh@thebrileys.com",
  "icon": {
  ...
  "nuxt-schema-org": {
    ...
    "identity": {
      ...
      "image": "http://localhost:3000/images/josh-mug-shot.jpg",
      "sameAs": [
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "/Users/joshuabriley/Documents/web/nuxt-apps/josh-dev-blog/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  },
  "nuxt-site-config": {
    "stack": [
      ...
      },
      {
        ...
        "url": "http://localhost:3000",
        "name": "Josh Briley | UX Software Engineer",
        "trailingSlash": true
      },
      {
        "_context": "buildEnv",
  ...
  "nuxt-og-image": {
    ...
    "debug": false,
    "baseCacheKey": "/cache/nuxt-og-image/5.1.3",
    "fonts": [
      {
...
const _e5ssZGZZ4n8121GiRm59JSZJgpwrUWiDW1mR50vLNww = defineNitroPlugin(async (nitroApp) => {
...
const _9c8iHeGv7bBk6XfjL5BGoNwReAUXZruiBOGxxNqJj2k = defineNitroPlugin(async (nitroApp) => {
...
const checksumsStructure = {
  "blog": "5sK0FzL4k2payPydU5y5bzGNTN5mjwrcU3qbaguFHUg",
  "projects": "7nctDYab6FsnJE63Drnd6aHEVu0ERG_r4i7KewntTRU",
  "experiments": "4Qkta7cg2pF3RaWfGcnyJeZ9k6shdklmL-k9bURIEXk",
  "services": "mZtGH4Ay_8ysAwybVGYmYDVErrhrNBpzJZaceP8RVns",
  "checklist": "VpZVkIpk2egkS2DtZDvdd8a0GAm88327FT-z4Cjlm9s",
  "dev_notes": "YRy17NY3N-9y2fr-tVX02V6BWdXVGbpqafXRQ15zkwo"
};
const tables = {
  "blog": "_content_blog",
...
const _U5NvLPexWw40zTTpE3RwRAPFwCe6QHnRqiuZFfMRaiM = defineNitroPlugin(async (nitro) => {
  return;
});

const plugins = [
  _e5ssZGZZ4n8121GiRm59JSZJgpwrUWiDW1mR50vLNww,
_9c8iHeGv7bBk6XfjL5BGoNwReAUXZruiBOGxxNqJj2k,
_U5NvLPexWw40zTTpE3RwRAPFwCe6QHnRqiuZFfMRaiM
];
...
const collections = {
  'ph': () => import('../_/icons.mjs').then(m => m.default),
  'skill-icons': () => import('../_/icons2.mjs').then(m => m.default),
};

const DEFAULT_ENDPOINT = "https://api.iconify.design";
const _E0BJp9 = defineCachedEventHandler(async (event) => {
...
const _cjwPN9 = defineEventHandler(async (e) => {
...
const _3u4gwr = defineEventHandler(async (e) => {
...
const _Tzpv43 = defineEventHandler(async (e) => {
...
const _BddTLk = defineEventHandler(async (e) => {
  const collections = [];
...
const _lgALHW = defineEventHandler(async (e) => {
...
const _ztxjXR = defineEventHandler(async (e) => {
...
const _1bBLim = eventHandler(async (event) => {
...
const _dwOcF4 = eventHandler(async (event) => {
...
const _lazy_rAVnrt = () => import('../routes/api/subscribe.post.mjs');
const _lazy_F2AeQo = () => import('../routes/renderer.mjs').then(function (n) { return n.b; });
const _lazy_vFP36W = () => import('../routes/__og-image__/font/font.mjs');
const _lazy_0ScNv4 = () => import('../routes/__og-image__/image/image.mjs');

const handlers = [
  { route: '/api/subscribe', handler: _lazy_rAVnrt, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_F2AeQo, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _E0BJp9, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _cjwPN9, lazy: false, middleware: true, method: undefined },
  { route: '/robots.txt', handler: _3u4gwr, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _Tzpv43, lazy: false, middleware: true, method: undefined },
  { route: '/__sitemap__/nuxt-content-urls.json', handler: _BddTLk, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _lgALHW, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _ztxjXR, lazy: false, middleware: false, method: undefined },
  { route: '/__og-image__/font/**', handler: _lazy_vFP36W, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/image/**', handler: _lazy_0ScNv4, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/static/**', handler: _lazy_0ScNv4, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/sql_dump', handler: _1bBLim, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/query', handler: _dwOcF4, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_F2AeQo, lazy: true, middleware: false, method: undefined }
];
...
export { decodeHtml as $, parseURL as A, setResponseHeader as B, proxyRequest as C, sendRedirect as D, resolveContext as E, createHooks as F, getContext as G, H3Error as H, toRouteMatcher as I, createRouter$1 as J, defu as K, hasProtocol as L, joinURL as M, withQuery as N, sanitizeStatusCode as O, isScriptProtocol as P, executeAsync as Q, withoutTrailingSlash as R, titleCase as S, withLeadingSlash as T, withBase as U, camelCase as V, withoutBase as W, defuFn as X, klona as Y, stringifyQuery as Z, parseQuery as _, getResponseStatus as a, logger as a0, toBase64Image as a1, htmlDecodeQuotes as a2, sendError as a3, fontCache as a4, pascalCase as a5, kebabCase as a6, handler as a7, buildAssetsURL as b, createError$1 as c, defineEventHandler as d, defineRenderHandler as e, getQuery as f, getResponseStatusText as g, getRouteRules as h, useNitroApp as i, destr as j, prefixStorage as k, useStorage as l, useNitroOrigin as m, emojiCache as n, useOgImageRuntimeConfig as o, publicAssetsURL as p, fetchIsland as q, readBody as r, normaliseFontInput as s, theme as t, useRuntimeConfig as u, handleCacheHeaders as v, withTrailingSlash as w, setHeaders as x, setHeader as y, hash$1 as z };
