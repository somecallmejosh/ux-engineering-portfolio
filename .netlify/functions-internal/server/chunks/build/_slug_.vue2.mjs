...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const allPosts = ([__temp, __restore] = withAsyncContext(() => queryCollection("blog").order("publishedAt", "DESC").all()), __temp = await __temp, __restore(), __temp).filter((post) => Array.isArray(post.tags) && post.tags.includes(slug));
    useHead({
      title: `${slug} | Blog`,
      meta: [
        { property: "og:title", content: `${slug} | Blog` },
    ...
    const articleLabel = postCount > 1 ? "Articles" : "Article";
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (unref(allPosts)) {
              ...
              _push2(`</section>`);
              _push2(ssrRenderComponent(_component_TagLinkList, { collection: "blog" }, null, _parent2, _scopeId));
            ...
            return [
              unref(allPosts) ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                ...
                createVNode(_component_TagLinkList, { collection: "blog" }),
