...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "call-out not-prose bg-blue-50 p-4 rounded-lg text-blue-950 border-l-4 border-blue-100 text-sm" }, _attrs))}>`);
...
//# sourceMappingURL=CallOut.vue.mjs.map
