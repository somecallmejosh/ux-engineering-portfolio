...
import { a5 as pascalCase, a6 as kebabCase, j as destr } from '../nitro/nitro.mjs';
...
const CallOut = () => import('./CallOut.vue.mjs');
const OverflowX = () => import('./OverflowX.vue.mjs');
const TagMenu = () => import('./TagMenu.vue.mjs');
...
const localComponents = ["CallOut", "OverflowX", "TagMenu"];
