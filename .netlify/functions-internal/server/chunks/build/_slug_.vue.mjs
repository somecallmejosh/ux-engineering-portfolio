...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const { data: post } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(`blog-${slug}`, () => {
          ...
          if (_push2) {
            ...
            if (unref(post)) {
              ...
              _push2(ssrRenderComponent(_component_CallOut, { class: "mb-6" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<strong${_scopeId2}>Blog disclaimer:</strong> Each article on this blog is strictly my own opinion and doesn&#39;t reflect the views of my employer or any other organization. `);
                    ...
                    _push3(` if you have questions or feedback. `);
                  } else {
                    return [
                      createVNode("strong", null, "Blog disclaimer:"),
                      createTextVNode(" Each article on this blog is strictly my own opinion and doesn't reflect the views of my employer or any other organization. "),
                      ...
                      createTextVNode(" if you have questions or feedback. ")
                    ];
                  }
                }),
                _: 1
