...
const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    snippet:
      "Josh's depth of knowledge was rock-solid, and he brought a thoughtful, disciplined approach to every project. Even with a high bar set for timelines and quality, Josh met or exceeded expectations every time.",
    testimonial:
  ...
  },
  {
    ...
    snippet:
      "Josh is still the gold standard to me for building UIs with a focus on all of the diverse users who will interact with it. He's the type of leader who multiplies everyone else's effectiveness.",
    testimonial:
  ...
  },
  {
    ...
    snippet:
      'Josh is very pragmatic and takes the time to really understand what a business offers and how to best represent that digitally.',
    testimonial:
