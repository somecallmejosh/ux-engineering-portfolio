...
tagline: Fix the handoff once. Stop having the same conversation every sprint.
price: '$2,000'
timeline: '1 week'
deliveredAs: 'Written process audit, workflow guide, and 60-minute implementation session.'
isFree: false
isComingSoon: false
description: 'An audit of your Figma-to-code handoff process, a custom workflow guide, and an implementation session to fix the friction between design and engineering, delivered in one week.'
