  ...
  <PageWrapper>
    ...
    <div v-if="post" class="prose">
      ...
      <aside class="space-y-6 lg:space-y-12">
        ...
        <CallOut class="mb-6"><strong>Dev Notes Disclaimer</strong>: Each artile in the <em>Dev Notes</em> section of my
          webiste may or may not be unfinished work. I don't always have time to write a full post. If you see something
